...
// See: https://www.zabbix.com/documentation/current/en/manual/api/reference/maintenance/object
...
// Maintenance returns a native Go Maintenance struct mapped from
// the given JSON Maintenance data.
